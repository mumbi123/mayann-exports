...
const ALL_REVIEWS = [
  ...
  { name: 'Eunice mutale',   country: 'Zambia', rating: 5, text: 'Imported office furniture for our company. Everything was exactly as described and the consolidation service saved us a lot on shipping. Will be ordering again next quarter.' },
  ...
  { name: 'Mutinta Hangala', country: 'Zambia', rating: 5, text: 'The first time I used MayAnn I was skeptical. Now I am on my sixth order and I cannot imagine importing without them. They genuinely care about your business succeeding.' },
  ...
  { name: 'Gift Mwanga',     country: 'Zambia', rating: 5, text: 'Starting an import business felt overwhelming until I found MayAnn. They made the whole process understandable and every order since has gone smoothly. Could not ask for more.' },
  ...
  // ── USA ───────────────────────────────────────────────────────────────────
  { name: 'Emily Johnson',  country: 'USA', rating: 5, text: 'I have worked with sourcing agents before but MayAnn is on a completely different level. They found me a verified manufacturer for my e-commerce brand within days. Quality control was thorough and shipping was seamless.' },
  ...
  { name: 'Daniel Wilson',   country: 'USA', rating: 4, text: 'Used MayAnn to source industrial equipment for our facility. The price comparison across multiple factories saved us several thousand dollars. Communication was professional throughout.' },
  ...
  { name: 'Tyler Fraser',   country: 'Canada', rating: 4, text: 'Good solid service. They compared four suppliers for my furniture order and the one they recommended has been excellent. Minor shipping delay but MayAnn stayed on top of it.' },
  { name: 'Ethan Thompson',      country: 'Canada', rating: 5, text: 'I source medical equipment for a healthcare company and MayAnn has been invaluable. Their verification process is meticulous and every delivery has matched the specifications exactly.' },
  { name: 'Charlotte Bennett',     country: 'Canada', rating: 5, text: 'The warehousing and consolidation service alone saved me thousands on freight. MayAnn thinks practically about cost efficiency which is exactly what a growing business needs.' },
  { name: 'Amelia Carter',     country: 'Canada', rating: 5, text: 'Used MayAnn to source gym equipment for our fitness centres. Exceptional quality, properly inspected and arrived on schedule. Our members have been very happy with the new equipment.' },
  ...
  { name: 'Henry Blackwood',    country: 'UK', rating: 4, text: 'Solid and dependable service. MayAnn compared multiple suppliers for my product range and the savings were real. One small customs query arose but they resolved it quickly and kept me informed.' },
